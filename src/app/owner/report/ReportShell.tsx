...
const MONTH_NAMES = ['Tháng 1','Tháng 2','Tháng 3','Tháng 4','Tháng 5',
...
export default function ReportShell({
  ...
  return (
    <div className="report-shell">
      ...
      {tab === 'setup' && (
        <CategorySetup onDone={() => { setTab('report'); loadReport(year, month, villaId); }} />
      )}
      ...
      <style>{`
        ...
        .report-loading { text-align:center; padding:24px; color:#8A8F9A; font-size:0.85rem; }
        .report-empty   { text-align:center; padding:48px; color:#8A8F9A; font-size:0.9rem; }
