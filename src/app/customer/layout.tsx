    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          <Link href="/customer/villas"   className="nav-item"><span className="nav-icon">🏠</span> Khám phá villa</Link>
          <Link href="/customer/bookings" className="nav-item"><span className="nav-icon">📋</span> Booking của tôi</Link>
        </nav>
